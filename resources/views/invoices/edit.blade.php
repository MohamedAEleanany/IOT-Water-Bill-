...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('invoice.update', ['invoice' => $invoice->id]) }}" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                        @method('PUT')
                        {{-- 1 --}}
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="inputName" class="control-label">الشريحه</label>
                            ...
                            <div class="col">
                                <label for="inputName" class="control-label">حدد رقم العداد</label>
                                <select name="serial_id" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    onchange="console.log('change is firing')">
                                    <!--placeholder-->
                                    <option value="{{ $invoice->client->id }}" selected> {{ $invoice->client->serial_id }}</option>
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="exampleTextarea">{{ $invoice->note }}</label>
    ...
    <script>
        function myFunction() {
            ...
            if (typeof Amount_Commission === 'undefined' || !Amount_Commission) {
                ...
                document.getElementById("Total").value = + sumq +parseFloat(document.getElementById('Amount_collection').value *2.5) ;
